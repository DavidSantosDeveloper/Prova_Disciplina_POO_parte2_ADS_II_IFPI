        ...
        if (arquivo != "") {
            ...
            for (let i = 0; i < linhas.length; i++) {
                ...
                if (tipo == 'PA') {
                    ...
                    postagem = new PostagemAvancada(Number(linhaConta[0]), linhaConta[1], Number(linhaConta[2]), Number(linhaConta[4]), new Date(linhaConta[5]), perfil_da_postagem, lista_de_hashtags_pronta, Number(linhaConta[8]));
